                ...
                <div className='container'>
                    <div className='flex gap-8 sm:flex-col sm:gap-4'>
                        <div
                            ...
                            <ul className='flex gap-3 flex-col -mt-3 mx-12 mb-12 sm:gap-[2px] md:mx-7 md:mt-2 md:mb-8'>
                        ...
                        <div
                            ...
                            <ul className='flex gap-3 sm:gap-[2px] flex-col md:mx-7 md:mt-2 mt-10 md:mb-8 mx-12'>
                                <li className='flex gap-1'>
